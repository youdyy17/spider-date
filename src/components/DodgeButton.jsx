...
export default function DodgeButton({ offset, onDodge }) {
  return (
    <button
      ...
      className={`relative z-[6] cursor-pointer select-none rounded-2xl border-4 border-[#08080f] bg-[linear-gradient(160deg,#3a6ee0,#1f3f9e)] px-[38px] py-[14px] ${type.actionBtnLg} text-white shadow-[6px_6px_0_#08080f] transition-transform duration-[220ms] ease-[cubic-bezier(0.3,1.4,0.5,1)]`}
    >
      NO 🙈
    </button>
  );
